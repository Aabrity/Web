                        ...
                        <div className={"desc2"}>
                            ...
                            <div className={"desc4"}>
                                ...
                                <div className={"sizeoptions"}>
                                    <span onClick={() => handleSizeSelection('XS')}  className={selectedSize === 'XS ' ? 'selectedSize' : ''}>XS (Paper Back)</span>
                                    <span onClick={() => handleSizeSelection('S')}  className={selectedSize === 'S ' ? 'selectedSize' : ''}>S (Paper Back)</span>
                                    <span onClick={() => handleSizeSelection('M')}  className={selectedSize === 'M ' ? 'selectedSize' : ''}>M (Paper Back)</span>
                                    <span onClick={() => handleSizeSelection('L')}  className={selectedSize === 'L' ? 'selectedSize' : ''}>L (Hard Cover)</span>
                                    <span onClick={() => handleSizeSelection('XL')}  className={selectedSize === 'XL' ? 'selectedSize' : ''}>XL (Hard Cover)</span>
                                    <span onClick={() => handleSizeSelection('2XL')}  className={selectedSize === '2XL' ? 'selectedSize' : ''}>2XL (Hard Cover)</span>
                                </div>
                            </div>
                            <div className={"desc5"}>
                                <p>Quantity:</p>
